...
| 0008 | Checkerboard artifact identified; disable VAE tiling | pending | Visual zoom-in on 0007's frames revealed a clean, regular checkerboard/basket-weave texture (not noise) across every frame of every iteration since VAE tiling was enabled (0002) - a well-documented deconvolution/tiling artifact signature. Testing with tiling disabled. |
