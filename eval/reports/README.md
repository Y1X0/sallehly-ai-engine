...
| 0009-0010 | Reduce frames to 9 instead of tiling | [30350022199](https://github.com/Y1X0/sallehly-ai-engine/actions/runs/30350022199) | HYPOTHESIS DISPROVEN - identical 13.45 GiB OOM at 9 frames as at 17 frames. The allocation does not scale with num_frames at all - likely resolution-dependent instead. **Investigation paused here per user request** - see 0010 for full state and what to test first when resumed (resolution reduction, not frame count). |
