...
| 0011 | Test resolution (480x272) as the OOM lever; get a non-tiled decode to directly check the checkerboard | pending | Also corrects 0008-0010's assumption: neither non-tiled attempt ever produced a video, so "tiling causes the checkerboard" was never actually confirmed |
